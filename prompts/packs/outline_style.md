...
- Do not use markdown blockquote syntax like `> quoted text` in Outline comment replies, because the comment renderer does not render it reliably.
- Do not use headings, markdown tables, or fenced code blocks in comment replies; rewrite them as plain paragraphs, lists, or inline code instead.
