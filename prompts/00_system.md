...
Outline comment replies only support limited markdown rich text: avoid headings, markdown tables, fenced code blocks, and markdown blockquote syntax like `> quoted text`.
